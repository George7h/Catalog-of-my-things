...
RSpec.describe Movie do
  ...
  describe '#can_be_archived?' do
    context 'when the movie is silent' do
      it 'returns true' do
        movie = Movie.new('Sci-Fi', 'Christopher Nolan', 'Hollywood', time(2023-0o1-01), true)
